 ...
 */
public class Saver {//NO NEED TO APPLY COMPRESSION ANYWHERE HERE BUT HANDLE DICTIONARY
	 ...
	 */
	public Saver() {
		String fileName = DEFAULTPATH + "\\default.cmp";
		try (BufferedWriter bw = new BufferedWriter(new FileWriter(fileName))) {
			String dictionaryLine = Compressor.getDictionaryLine();
			bw.write(dictionaryLine);
			bw.newLine();
			String content;
	 ...
	 */
	public Saver(String line) {//APPLY COMPRESSION AND HANDLE DICTIONARY
		String fileName = DEFAULTPATH + "\\" + line + ".cmp";
		try (BufferedWriter bw = new BufferedWriter(new FileWriter(fileName))) {
			String dictionaryLine = Compressor.getDictionaryLine();
			bw.write(dictionaryLine);
			bw.newLine();
